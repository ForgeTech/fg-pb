...
export interface UpdateStatus {
   ...
   */
  orderModType?: OrderModTypeUpdateStatusEnum;
  /** Include pre-arranged orders (default = false) */
  inclPreArranged?: boolean;
  /** Restrict the request to the given product(s) */
  prodName?: string[];
}

export type OrderModTypeUpdateStatusEnum =
  'ACTI' |
  'DEAC' |
  'DELE';
