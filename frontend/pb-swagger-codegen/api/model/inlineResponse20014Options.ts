...
export interface InlineResponse20014Options { 
    /**
     * Releative position limt (per contract)  in MW
     */
    relativePositionLimit?: number;
    /**
     * Absolute position limt (per contract)  in MW
     */
    absolutePositionLimit?: number;
    internalTrading?: InlineResponse20014Options.InternalTradingEnum;
    /**
     * In multi-area configurations, set this option in case you want a default delivery area
     */
    defaultDeliveryAreaId?: string;
}
export namespace InlineResponse20014Options {
    export type InternalTradingEnum = 'inactive' | 'default_yes' | 'default_no';
    export const InternalTradingEnum = {
        Inactive: 'inactive' as InternalTradingEnum,
        DefaultYes: 'default_yes' as InternalTradingEnum,
        DefaultNo: 'default_no' as InternalTradingEnum
    };
}
