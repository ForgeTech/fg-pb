...
export class TradesService {
     ...
     */
    public getTrades(offset?: number, limit?: number, ordId?: number, activeOnly?: boolean, clOrdrId?: string, txt?: string, contractId?: number, fromApiTimestamp?: Date, toApiTimestamp?: Date, deliveryWithinStart?: Date, deliveryWithinEnd?: Date, observe?: 'body', reportProgress?: boolean): Observable<Array<InlineResponse2004>>;
    public getTrades(offset?: number, limit?: number, ordId?: number, activeOnly?: boolean, clOrdrId?: string, txt?: string, contractId?: number, fromApiTimestamp?: Date, toApiTimestamp?: Date, deliveryWithinStart?: Date, deliveryWithinEnd?: Date, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<InlineResponse2004>>>;
    public getTrades(offset?: number, limit?: number, ordId?: number, activeOnly?: boolean, clOrdrId?: string, txt?: string, contractId?: number, fromApiTimestamp?: Date, toApiTimestamp?: Date, deliveryWithinStart?: Date, deliveryWithinEnd?: Date, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<InlineResponse2004>>>;
    public getTrades(offset?: number, limit?: number, ordId?: number, activeOnly?: boolean, clOrdrId?: string, txt?: string, contractId?: number, fromApiTimestamp?: Date, toApiTimestamp?: Date, deliveryWithinStart?: Date, deliveryWithinEnd?: Date, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<InlineResponse2004>>(`${this.basePath}/trades`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public recallTrade(tradeId: number, observe?: 'body', reportProgress?: boolean): Observable<Array<InlineResponse2004>>;
    public recallTrade(tradeId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<InlineResponse2004>>>;
    public recallTrade(tradeId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<InlineResponse2004>>>;
    public recallTrade(tradeId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.delete<Array<InlineResponse2004>>(`${this.basePath}/trade/${encodeURIComponent(String(tradeId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
