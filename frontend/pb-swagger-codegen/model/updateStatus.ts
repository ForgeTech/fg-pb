...
export interface UpdateStatus { 
    /**
     * * ACTI: Activates the order. Ignored if already active. * DEAC: Deactivates (hibernates) the order. Hibernated orders are removed from the order book but are still available for modification or activation in the own orders list. * DELE: Delete the order
     */
    orderModType?: UpdateStatus.OrderModTypeEnum;
    /**
...
export namespace UpdateStatus {
    export type OrderModTypeEnum = 'ACTI' | 'DEAC' | 'DELE';
    export const OrderModTypeEnum = {
        ACTI: 'ACTI' as OrderModTypeEnum,
        DEAC: 'DEAC' as OrderModTypeEnum,
        DELE: 'DELE' as OrderModTypeEnum
    };
}
