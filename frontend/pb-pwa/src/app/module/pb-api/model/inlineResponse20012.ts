 ...
 */
import { InlineResponse20012Options } from './inlineResponse20012Options';
...
export interface InlineResponse20012 { 
    ...
    apiTimestamp?: Date;
    /**
     * The current state of the market * OK Everyhting's ok, trading is possible * WARNING Trading might not be possible, check the messages. * FAILURE Trading is not possible right now.        
     */
    status: InlineResponse20012.StatusEnum;
    options?: InlineResponse20012Options;
    /**
