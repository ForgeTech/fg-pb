...
export class ContractService {
     ...
     */
    public findContracts(contractId?: number, deliveryStart?: Date, deliveryEnd?: Date, observe?: 'body', reportProgress?: boolean): Observable<Array<InlineResponse2009>>;
    public findContracts(contractId?: number, deliveryStart?: Date, deliveryEnd?: Date, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<InlineResponse2009>>>;
    public findContracts(contractId?: number, deliveryStart?: Date, deliveryEnd?: Date, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<InlineResponse2009>>>;
    public findContracts(contractId?: number, deliveryStart?: Date, deliveryEnd?: Date, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<InlineResponse2009>>(`${this.basePath}/contracts`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getContractHistory(contractId: number, fromRevision?: number, observe?: 'body', reportProgress?: boolean): Observable<Array<InlineResponse2006>>;
    public getContractHistory(contractId: number, fromRevision?: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<InlineResponse2006>>>;
    public getContractHistory(contractId: number, fromRevision?: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<InlineResponse2006>>>;
    public getContractHistory(contractId: number, fromRevision?: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<InlineResponse2006>>(`${this.basePath}/contract/${encodeURIComponent(String(contractId))}/history`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getOrders(contractId: number, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse2008>;
    public getOrders(contractId: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse2008>>;
    public getOrders(contractId: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse2008>>;
    public getOrders(contractId: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (contractId === null || contractId === undefined) {
        ...
        return this.httpClient.get<InlineResponse2008>(`${this.basePath}/contract/${encodeURIComponent(String(contractId))}/orders`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getPublicTrades(contractId: number, offset?: number, limit?: number, fromApiTimestamp?: Date, toApiTimestamp?: Date, observe?: 'body', reportProgress?: boolean): Observable<Array<InlineResponse2007>>;
    public getPublicTrades(contractId: number, offset?: number, limit?: number, fromApiTimestamp?: Date, toApiTimestamp?: Date, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<InlineResponse2007>>>;
    public getPublicTrades(contractId: number, offset?: number, limit?: number, fromApiTimestamp?: Date, toApiTimestamp?: Date, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<InlineResponse2007>>>;
    public getPublicTrades(contractId: number, offset?: number, limit?: number, fromApiTimestamp?: Date, toApiTimestamp?: Date, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (contractId === null || contractId === undefined) {
        ...
        return this.httpClient.get<Array<InlineResponse2007>>(`${this.basePath}/contract/${encodeURIComponent(String(contractId))}/publictrades`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
