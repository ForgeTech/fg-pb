...
export class LogsService {
     ...
     * The Powerbot Trading api helps you to record what your algorithm is doing. You can use this method to log the activity of your trading algorithm. These logs can be retrieved later by you or displayed by the Powerbot GUI.
     * @param value 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public addLogEntry(value: Value1, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public addLogEntry(value: Value1, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public addLogEntry(value: Value1, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public addLogEntry(value: Value1, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (value === null || value === undefined) {
            throw new Error('Required parameter value was null or undefined when calling addLogEntry.');
        }
     ...
     * @param receivedFrom from timestamp is &#39;inclusive&#39; (i.e. &gt;&#x3D;), use UTC time zone
     * @param receivedTo to timestamp is &#39;exclusive&#39; (i.e. &lt;), use UTC time zone
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getLogs(offset?: number, limit?: number, severityAtLeast?: 'LOW' | 'MED' | 'HIG' | 'ERR' | 'URG', receivedFrom?: Date, receivedTo?: Date, observe?: 'body', reportProgress?: boolean): Observable<Array<InlineResponse2001>>;
    public getLogs(offset?: number, limit?: number, severityAtLeast?: 'LOW' | 'MED' | 'HIG' | 'ERR' | 'URG', receivedFrom?: Date, receivedTo?: Date, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<InlineResponse2001>>>;
    public getLogs(offset?: number, limit?: number, severityAtLeast?: 'LOW' | 'MED' | 'HIG' | 'ERR' | 'URG', receivedFrom?: Date, receivedTo?: Date, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<InlineResponse2001>>>;
    public getLogs(offset?: number, limit?: number, severityAtLeast?: 'LOW' | 'MED' | 'HIG' | 'ERR' | 'URG', receivedFrom?: Date, receivedTo?: Date, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<InlineResponse2001>>(`${this.basePath}/logs`,
            {
