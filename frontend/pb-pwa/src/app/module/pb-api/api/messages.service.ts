...
export class MessagesService {
     ...
     */
    public getMessages(offset?: number, limit?: number, fromApiTimestamp?: Date, toApiTimestamp?: Date, messageClassIs?: string, messageClassIsNot?: string, correlationId?: string, sortBy?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<InlineResponse20016>>;
    public getMessages(offset?: number, limit?: number, fromApiTimestamp?: Date, toApiTimestamp?: Date, messageClassIs?: string, messageClassIsNot?: string, correlationId?: string, sortBy?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<InlineResponse20016>>>;
    public getMessages(offset?: number, limit?: number, fromApiTimestamp?: Date, toApiTimestamp?: Date, messageClassIs?: string, messageClassIsNot?: string, correlationId?: string, sortBy?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<InlineResponse20016>>>;
    public getMessages(offset?: number, limit?: number, fromApiTimestamp?: Date, toApiTimestamp?: Date, messageClassIs?: string, messageClassIsNot?: string, correlationId?: string, sortBy?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<InlineResponse20016>>(`${this.configuration.basePath}/messages`,
            {
